                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-4 mb-4 text-center text-md-start div-logo-footer">
                        ...
                        <p className="footer-description">
                            ...
                            Descubra, pesquise e se conecte com histórias inesquecíveis.
                        </p>
                    </div>
                    ...
                    <div className="col-6 col-md-2 mb-3 navigation">
                        ...
                        <ul className="nav flex-column">
                            ...
                            <li><Link href="/categorias" className="footer-link">Categorias</Link></li>
                            <li><Link href="/blog" className="footer-link">Blog</Link></li>
                            <li><Link href="/sobre" className="footer-link">Sobre Nós</Link></li>
                            <li><Link href="/contato" className="footer-link">Fale Conosco</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="col-md-4 mb-3 newsletter">
                        ...
                        <form className="d-flex flex-column flex-sm-row gap-2">
                            ...
                            />
                            <button type="submit" className="btn btn-outline-warning">Inscrever</button>
                        </form>
                    </div>
                </div>
