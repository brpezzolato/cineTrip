...
export default function Card({ item, tipo }) {
  ...
  const indica = [
    ...
    62134, 66729, 78029, 85271, 119051, 299536, 687163,
  ];
  ...
  const oscar = [
    ...
    703745, 706972, 765869, 701387, 911430, 1062722, 858024, 1317288, 1054867, 1220564, 1124566, 1233413, 1241983
  ];
  ...
  const ganhadores = [
    ...
    1000837, 1054867, 1233413, 858024, 1078605, 1062722, 1124566, 803796
  ];
    ...
    <Link href={rota}>
      ...
      >
        ...
        <img
          ...
          className="img-fluid rounded abc"
          loading="lazy"
        />
        <div className="overlay d-flex flex-column container justify-content-end !gap-y-0">
          <p className="text-white">
            <i className="bi bi-cassette"></i> {item.title || item.name}
          </p>
          <p>
            <i className="bi bi-star"></i> {item.vote_average.toFixed(1)}
          </p>
          <p>
