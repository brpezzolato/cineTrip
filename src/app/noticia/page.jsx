            ...
            <section className="noticias">
                <div className="superior">
                    <div className="title-noticia">
                        ...
                        <p>subtitulo da noticia</p>
                    </div>
                </div>
                <div className="meio">
                    <div className="imagem">
                        <img className="bannerNoticia" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnT4ruHb7gNtl_hNM9fnS7KKms2OXRzbh1pA&s" />
                    </div>
                ...
                <div className="corpoNoticia">
                    <p>A passagem do Lorem Ipsum usada desde 1500
