...
export default function Categorias() {
  ...
  useEffect(() => {
    ...
    fetch(`${url}discover/movie?api_key=${chave}&language=pt-BR&with_genres=878`)
      .then(res => res.json())
      ...
      <div className="container text-white">
        ...
        <div className="treanding">
          <div className="titulo-destaque mt-5 mb-4">
            <h1>Filmes de <span>Ação</span></h1>
          </div>
        ...
        <div className="treanding">
          <div className="titulo-destaque mt-5 mb-4">
            <h1>Filmes de <span>Comédia</span></h1>
          </div>
          <div className="carrosel-trending">
        ...
        <div className="treanding">
          <div className="titulo-destaque mt-5 mb-4">
            <h1>Filmes de <span>Terror</span></h1>
          </div>
          <div className="carrosel-trending">
        ...
        <div className="treanding">
          <div className="titulo-destaque mt-5 mb-4">
            <h1>Filmes de <span>Ficção científica</span></h1>
          </div>
          <div className="carrosel-trending">
