...
export default function Streaming() {
            ...
            <div className="d-flex align-items-center justify-content-center px-3 invalido">
                <div className="text-center d-flex flex-column gap-3">
                    <h1 className="text-warning">
                        ...
                        Streaming <span className="text-white">inválido</span><br />
    ...
    const resultadosEncontrados = resultados.filter(item => item.poster_path != null)
        ...
        <>
            ...
            <div className="container container-str">
                ...
                <div className="voltar-topo d-flex m-5 justify-content-center">
                    <button className="btn btn-outline-warning" onClick={scrollTop}>voltar ao topo <i className="bi bi-arrow-bar-up ps-2"></i></button>
                </div>
            </div>
        </>
    )
